    ...
    public Agent Create()
    {
        var definition = new AgentDefinition
        {
            ...
            Instructions =
                ...
                Table should have the following columns: User Story, Task, Optimistic, Realistic, Pessimistic, Effort, Correction Reason.
                Include correction reason for each task if optimistic, realistic, or pessimistic estimates were modified. If no modifications were made, leave the Correction Reason column empty.
                ...
                |User Story|Task|Optimistic|Realistic|Pessimistic|Effort|Correction Reason|
                |:---|:---|:---|:---|:---|:---|:---|
